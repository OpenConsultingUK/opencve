...
# crontab entry to run every hour at 55 minutes
# 55 * * * * /home/ubuntu/tets_1/dir_hie.sh >> /home/ubuntu/tets_1/dir_hie.log 2>&1
...
REPOS=(
    ...
    "$HOME/tets_1/patch_dir/opencve_repos/cvelistV5"
    "$HOME/tets_1/patch_dir/opencve_repos/vulnrichment"
)
...
REPO_URLS["cvelistV5"]="git@github.com:opencve/cvelistV5.git
REPO_URLS["vulnrichment"]="git@github.com:opencve/vulnrichment.git
